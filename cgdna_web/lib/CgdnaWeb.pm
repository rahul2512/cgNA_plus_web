...
sub startup {
  ...
  $r->get('/isalive')->to(controller => 'Root', action => 'isalive');
  ...
  $if_loggedin->get('/view2')->to(controller => 'Viewer', action => 'view2');
  ...
  # added phv 20201117
  $if_loggedin->get('/data4/:seq_id')->to(controller => 'DataProvider', action => 'data4');
}
